...
- Opening: Brief presentation from Folkuniversitetet Örebro (study circle organizers)
- Main topics:
    - Introductions, expectations, and prior experience (none required).
    - Practicals: time/place cadence, communication between sessions.
...
- Meet: 17:00 outside Hörsal T ([Map](https://link.mazemap.com/SuGWpIjj))
- Plan: Walk together to the lab space where we will work
- Focus: Build the S500 V2 frame and solder the power system
- Main topics:
    - Assemble the S500 V2 frame.
